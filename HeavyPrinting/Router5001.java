...
public class Router5001 {//NEW CLASS CHANGE

    private static Router5001 classInstance;//NEW CLASS CHANGE

    private DatagramSocket socket;
    private InetAddress localhost;
    private int hostPort = 5001;//NEW CLASS CHANGE
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 1) {
            ...
            classInstance = new Router5001();//NEW CLASS CHANGE
        ...
        while (true){
            try {
                ...
                for (int i =0; i < vectorValueLean.size(); i++){
                    ...
                    /*
                    If the cost from 5001 to the sending node plus the cost from the sending node to
                    the destination in question is < the current cost from 5001 to the destination,
                    update 5001 routing table by updating routerNode object. Then use routerNode as template
                    for new file.
                    */
