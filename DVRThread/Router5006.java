...
public class Router5006 { //NEW CLASS CHANGE

    private static Router5006 classInstance; //NEW CLASS CHANGE
    private static DatagramSocket socket;
    private InetAddress localHost;
    private static int hostPort = 5006; //NEW CLASS CHANGE
    ...
    */
    ...
    public static void main(String[] args){
        ...
        classInstance = new Router5006(); //NEW CLASS CHANGE

        classInstance.setupConstants(args);

        new ListenAndUpdate5006(socket, filename, hostPort).start(); //NEW CLASS CHANGE
...
class ListenAndUpdate5006 extends Thread{ //NEW CLASS CHANGE
    ...
    public ListenAndUpdate5006(DatagramSocket socket, String filename, int hostPort) { //NEW CLASS CHANGE
        this.socket = socket;
