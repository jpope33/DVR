...
public class Router5005 { //NEW CLASS CHANGE

    private static Router5005 classInstance; //NEW CLASS CHANGE
    private static DatagramSocket socket;
    private InetAddress localHost;
    private static int hostPort = 5005; //NEW CLASS CHANGE
    ...
    */
    ...
    public static void main(String[] args){
        ...
        classInstance = new Router5005(); //NEW CLASS CHANGE

        classInstance.setupConstants(args);

        new ListenAndUpdate5005(socket, filename, hostPort).start(); //NEW CLASS CHANGE
...
class ListenAndUpdate5005 extends Thread{ //NEW CLASS CHANGE
    ...
    public ListenAndUpdate5005(DatagramSocket socket, String filename, int hostPort) { //NEW CLASS CHANGE
        this.socket = socket;
