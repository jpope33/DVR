...
public class Router5001 { //NEW CLASS CHANGE
    ...
    private static int hostPort = 5001; //NEW CLASS CHANGE
...
class ListenAndUpdate5001 extends Thread{ //NEW CLASS CHANGE
    ...
    public ListenAndUpdate5001(DatagramSocket socket, String filename, int hostPort) { //NEW CLASS CHANGE
        this.socket = socket;
