...
public class Router5004 { //NEW CLASS CHANGE
    ...
    private static int hostPort = 5004; //NEW CLASS CHANGE
    ...
    */
    ...
    public static void main(String[] args){
        ...
        new ListenAndUpdate5004(socket, filename, hostPort).start(); //NEW CLASS CHANGE
...
class ListenAndUpdate5004 extends Thread{ //NEW CLASS CHANGE
    ...
    public ListenAndUpdate5004(DatagramSocket socket, String filename, int hostPort) { //NEW CLASS CHANGE
        this.socket = socket;
