...
public class Router5003 { //NEW CLASS CHANGE

    private static Router5003 classInstance; //NEW CLASS CHANGE
    private static DatagramSocket socket;
    private InetAddress localHost;
    private static int hostPort = 5003; //NEW CLASS CHANGE
    ...
    */
    ...
    public static void main(String[] args){
        ...
        classInstance = new Router5003(); //NEW CLASS CHANGE

        classInstance.setupConstants(args);

        new ListenAndUpdate5003(socket, filename, hostPort).start(); //NEW CLASS CHANGE
...
class ListenAndUpdate5003 extends Thread{ //NEW CLASS CHANGE
    ...
    public ListenAndUpdate5003(DatagramSocket socket, String filename, int hostPort) { //NEW CLASS CHANGE
        this.socket = socket;
